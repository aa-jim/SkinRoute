...
- **Adoption gate tightened**: the drop candidate must ALSO have residual top-up <= wp.bdt + 10 - so at 0 dia (and other dia-poor inputs) the day-1 pass stays (it is the cheapest dia source); it only disappears at dia >= ~2,023 where your own diamonds + the phase passes cover the requirement (0 dia back to 4,737 with the pass; 2,025 stays 1,175/1,271 without it).
